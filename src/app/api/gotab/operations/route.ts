...
function localPreviewOperations() {
  ...
  const verifiedProductUuids: Record<string, string> = {
    ...
    "addon:appetizer-refill-tater-kegs": "prd_4EGxn~hzX94JKyomJjb9f09T",
    "addon:appetizer-refill-mozzarella-sticks": "prd_r9_GAyvRBsWq9ZGdv9YWxvqL",
    "addon:appetizer-refill-chicken-tenders": "prd_x1R9l1G~G3JvH9QsgbFYlWR6",
    "addon:appetizer-refill-marinara": "prd_xPjiPxpYWKMD86DlMazf~tvX",
    "addon:appetizer-refill-ranch": "prd_wM9dm63TdPWBKXszBSuaJKhu",
    "addon:wing-refill-wings": "prd_Ygwt7EFZ1Za6XPC50OBinTq3",
    "addon:wing-refill-fries": "prd_L2rZUgTm4zy06mSc2JZky5BP",
    "addon:wing-refill-ranch": "prd_wM9dm63TdPWBKXszBSuaJKhu",
    "addon:wing-refill-bbq": "prd_a7f6Zpe_0WsCxf_yftoeP1pA",
    "addon:wing-refill-garlic-parm": "prd_PTAj89JiWG_7Y6ZqUwxbvLpc",
    "addon:wing-refill-buffalo": "prd_vKYxPhSn1KFaofG7ZzJi_Wll",
  ...
  const mappingRows = [
    ...
    ["addon:appetizer-refill-tater-kegs", "Tater Kegs Refill", "REFILL", "FRYER"],
    ["addon:appetizer-refill-mozzarella-sticks", "Mozzarella Sticks Refill", "REFILL", "FRYER"],
    ["addon:appetizer-refill-chicken-tenders", "Chicken Tenders Refill", "REFILL", "FRYER"],
    ["addon:appetizer-refill-marinara", "Marinara Refill", "REFILL", "COLD_PREP"],
    ["addon:appetizer-refill-ranch", "Ranch Refill", "REFILL", "COLD_PREP"],
    ["addon:wing-refill-wings", "Wings Refill", "REFILL", "FRYER"],
    ["addon:wing-refill-fries", "Fries Refill", "REFILL", "FRYER"],
    ["addon:wing-refill-ranch", "Ranch Refill", "REFILL", "COLD_PREP"],
    ["addon:wing-refill-bbq", "BBQ Refill", "REFILL", "COLD_PREP"],
    ["addon:wing-refill-garlic-parm", "Garlic Parm Refill", "REFILL", "COLD_PREP"],
    ["addon:wing-refill-buffalo", "Buffalo Sauce Refill", "REFILL", "COLD_PREP"],
